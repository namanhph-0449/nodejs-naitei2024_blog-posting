...
export class InitialMigration1725601330633 implements MigrationInterface {
    name = 'InitialMigration1725601330633'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`post\` ADD \`imageUrl\` varchar(255) NULL`);
